...
var solveURI = '/solveWarehouse';

app.post(solveURI, function (req, res) {
  res.setHeader('Content-Type', 'application/json');
  var attachments = [];
  // For this entry point, we solve the warehouse problem.
  // Replace ['warehouse_cloud.mod', 'warehouse_cloud.dat'] by ['diet.lp'] or ['steelmill.mod', 'steelmill.dat'] for solving the diet or steelmill problem
  var files = ['warehouse_cloud.mod', 'warehouse_cloud.dat'];
